# Projeto, criar um gerenciamento de notas
# Objetivo
# Criar um sistema que permita: Cadastrar alunos, inserir notas para alunos, calcular média e status de aprovação
# e exibir o relatório com os dados de todos os alunos
...
def cadastrar_aluno(alunos):
    ...
    if nome.strip() == "":
        ...
        return
    if nome in alunos:
        print("Aluno já foi inserido no sistema anteriormente.")
        return
    alunos[nome] = []
